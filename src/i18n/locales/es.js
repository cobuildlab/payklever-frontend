export default {
  ...
  CREATE_CAMPAIGN: {
    ...
    smsQuantity: 'Cantidad de mensajes',
    emptyBudget: 'Presupuesto requerido',
    invalidBudget: 'Presupuesto inválido (min $1)',
    invalidSmsQuantity: 'Cantidad de mensajes inválida (min 1)',
    createCampaign: 'Crear campaña',
    editCampaign: 'Editar campaña',
  ...
  PARAMETERS: {
    editParameters: 'Editar parámetros',
    resetHeader: 'Reiniciar parámetro?',
    ...
    update: 'Editar',
    reset: 'Reiniciar',
    updatingParameter: 'Editando parámetro',
    resetingParameters: 'Reiniciando parámetro',
    loadingParameters: 'Cargando parámetros',
    parameterResetted: 'El parámetro fue reiniciado satisfactoriamente',
    parameterUpdated: 'El parámetro fue actualizado satisfactoriamente',
  },
}
